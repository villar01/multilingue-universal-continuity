...
export function FlyingSOSBook({ className = "fixed bottom-6 left-4 z-[80]" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`${className} sos-floating-book group flex items-center gap-2 rounded-md border border-amber-200/80 bg-white px-3 py-2 text-slate-900 shadow-xl transition duration-200 hover:-translate-y-1 hover:shadow-2xl active:scale-[0.97]`}
