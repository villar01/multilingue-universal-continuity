...
const PLANS = [
  {
    ...
    features: [
      ...
      "57 professores virtuais animados",
  ...
  {
    id: "lifetime",
    name: "Vitalício — 1 Ano e Meio",
    priceUSD: 998.90 / 5.7,
    normalPriceUSD: 1437.60 / 5.7,
    price: 998.90,
    normalPrice: 1437.60,
    description: "Acesso vitalício — equivale a 1 ano e meio (18 meses)",
    features: [
      "Todos os 69 idiomas para sempre",
      "200+ lições por idioma",
      "Conversão com IA ilimitada",
      "Análise de pronúncia em tempo real",
      "Exercícios personalizados por IA",
