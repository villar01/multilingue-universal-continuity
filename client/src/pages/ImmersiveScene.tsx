...
const LANG_TEACHERS: Record<string, { name: string; image: string }> = {
  "en":  { name: "James",  image: "/manus-storage/prof_james_0aee8d8d.png" },
  "pt":  { name: "Ana",    image: "/manus-storage/prof_ana_7f3a2b91.png" },
  "es":  { name: "Carlos", image: "/manus-storage/prof_carlos_v2_fff862cf.jpg" },
  "fr":  { name: "Sophie", image: "/manus-storage/prof_sophie_efa02a67.png" },
  "de":  { name: "Hans",   image: "/manus-storage/prof_hans_7e788467.png" },
  "it":  { name: "Giulia", image: "/manus-storage/prof_giulia_9e244159.png" },
  "ja":  { name: "Yuki",   image: "/manus-storage/prof_yuki_cfeb5ca6.png" },
  "ar":  { name: "Omar",   image: "/manus-storage/prof_omar_5be02afe.png" },
  "ru":  { name: "Ivan",   image: "/manus-storage/prof_ivan_752b0cef.png" },
  "pl":  { name: "Maja",   image: "/manus-storage/prof_maja_f8ce331b.png" },
  "tr":  { name: "Emre",   image: "/manus-storage/prof_emre_2a7313d7.png" },
  "hi":  { name: "Priya",  image: "/manus-storage/prof_priya_3389cc9a.png" },
};
...
export const IMMERSIVE_SCENES: Scene[] = [
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    bgImage:"/manus-storage/scene_paris_c0991718.jpg",
    teacherImage:"/manus-storage/prof_sophie_efa02a67.png",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_beach_582e4928.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_forest_2d8a8128.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_tokyo_4ebb719f.jpg",
    teacherImage:"/manus-storage/prof_yuki_cfeb5ca6.png",
    teacherName:"Yuki", teacherLang:"ja-JP", langCode:"ja",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_newyork_5409691a.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_kitchen_dd6801a0.jpg",
    teacherImage:"/manus-storage/prof_carlos_v2_fff862cf.jpg",
    teacherName:"Carlos", teacherLang:"es-ES", langCode:"es",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_restaurant_cbd64ea7.jpg",
    teacherImage:"/manus-storage/prof_ana_7f3a2b91.png",
    teacherName:"Ana", teacherLang:"pt-BR", langCode:"pt",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_airport_b7331bb2.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_hotel_51e6d001.jpg",
    teacherImage:"/manus-storage/prof_giulia_9e244159.png",
    teacherName:"Giulia", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_supermarket_495343a4.jpg",
    teacherImage:"/manus-storage/prof_carlos_v2_fff862cf.jpg",
    teacherName:"Carlos", teacherLang:"es-ES", langCode:"es",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_school_13cc1551.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_hospital_4145acdb.jpg",
    teacherImage:"/manus-storage/prof_priya_3389cc9a.png",
    teacherName:"Priya", teacherLang:"en-GB", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_park_35a98c20.jpg",
    teacherImage:"/manus-storage/prof_sophie_efa02a67.png",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_mountain_90d64b16.jpg",
    teacherImage:"/manus-storage/prof_hans_7e788467.png",
    teacherName:"Hans", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_desert_38703c1b.jpg",
    teacherImage:"/manus-storage/prof_omar_5be02afe.png",
    teacherName:"Omar", teacherLang:"ar-SA", langCode:"ar",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_farm_9b78425f.jpg",
    teacherImage:"/manus-storage/prof_maja_f8ce331b.png",
    teacherName:"Maja", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_museum_85eac2fd.jpg",
    teacherImage:"/manus-storage/prof_giulia_9e244159.png",
    teacherName:"Giulia", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_cinema_9200d6a0.jpg",
    teacherImage:"/manus-storage/prof_james_0aee8d8d.png",
    teacherName:"James", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_gym_434e9cb3.jpg",
    teacherImage:"/manus-storage/prof_emre_2a7313d7.png",
    teacherName:"Emre", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_library_54860d36.jpg",
    teacherImage:"/manus-storage/prof_maja_f8ce331b.png",
    teacherName:"Maja", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_office_c91f8489.jpg",
    teacherImage:"/manus-storage/prof_ivan_752b0cef.png",
    teacherName:"Ivan", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_metro_c622d1f0.jpg",
    teacherImage:"/manus-storage/prof_sophie_efa02a67.png",
    teacherName:"Sophie", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_port_c8017fb0.jpg",
    teacherImage:"/manus-storage/prof_giulia_9e244159.png",
    teacherName:"Giulia", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_medieval_11fb6589.jpg",
    teacherImage:"/manus-storage/prof_hans_7e788467.png",
    teacherName:"Hans", teacherLang:"en-US", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_spa_86048278.jpg",
    teacherImage:"/manus-storage/prof_priya_3389cc9a.png",
    teacherName:"Priya", teacherLang:"en-GB", langCode:"en",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_garden_7fb30076.jpg",
    teacherImage:"/manus-storage/prof_yuki_cfeb5ca6.png",
    teacherName:"Yuki", teacherLang:"ja-JP", langCode:"ja",
  ...
  },
  {
    ...
    bgImage:"/manus-storage/scene_cafe_31cb0299.jpg",
    teacherImage:"/manus-storage/prof_sophie_efa02a67.png",
    teacherName:"Sophie", teacherLang:"fr-FR", langCode:"fr",
...
export default function ImmersiveScene() {
  ...
  const speak = useCallback(async (text: string, lang: string, _rate?: number) => {
    if (!text?.trim()) return;
