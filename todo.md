...
- [x] Adicionar regressões CEFR dedicadas aos fluxos curriculares prioritários que já recebem estágio, preservando a progressão A1–C2 entre lição, prática e conversa — concluído e detalhado no registro de validação subsequente
- [x] Adicionar regressões CEFR dedicadas aos fluxos curriculares prioritários que já recebem estágio, preservando a progressão A1–C2 entre lição, prática e conversa — conversa livre valida os seis níveis e o envio ao serviço; lições e ciclo Pareto validam o contrato CEFR e a exigência por nível; TypeScript e suíte completa com 234 arquivos/575 testes aprovados
...
- [x] Verificar e corrigir o envio de pergunta livre ao professor na Cena Praia Tropical, assegurando que campo e botão respondam sem alterar diálogo, áudio, clipes, hotspots ou controles — campo, Enter e botão encaminham a consulta ao tutor, “What is pool?” devolve definição, exemplo e tradução imediatos e a resposta fica escrita; TypeScript e suíte completa com 222 arquivos/536 testes aprovados
- [x] Adicionar controle de velocidade para fala do professor e ajuda nativa, com resposta escrita persistente e opções de estudo lento e normal na Cena Praia Tropical — velocidades 0,7×, 0,85× e 1× aplicadas ao único áudio de diálogo, voz do navegador, ajuda nativa e texto sincronizado; TypeScript e suíte completa com 222 arquivos/536 testes aprovados
- [x] Persistir a velocidade de estudo escolhida pelo aluno para fala do professor e ajuda nativa entre cenas e retornos ao aplicativo — concluído e detalhado no registro de validação subsequente
- [x] Persistir a velocidade de estudo escolhida pelo aluno para fala do professor e ajuda nativa entre cenas e retornos ao aplicativo — apenas 0,7×, 0,85× e 1× são aceitos; valor válido é restaurado e falhas de armazenamento preservam a sessão; TypeScript e suíte completa com 231 arquivos/560 testes aprovados
- [x] Garantir que a expansão aos 143 idiomas ocorra em blocos isolados, sem liberar, substituir ou reduzir a oferta comercial protegida dos seis idiomas iniciais — apenas português, inglês, espanhol, francês, italiano e alemão são liberados como idiomas-alvo comerciais; apoio nativo permanece universal e blocos futuros retornam estado planejado sem conteúdo substituto; TypeScript e suíte completa com 223 arquivos/538 testes aprovados
...
- [x] Conectar o seletor de professor à Cena Imersiva — cada uma das seis línguas iniciais oferece professores com retrato compatível, e o professor selecionado passa a identificar o avatar, o diálogo, a pergunta livre e a voz; fotografias e materiais originais permanecem como fallback; TypeScript, 540 testes e validação visual aprovados
- [ ] Entregar material de cena localizado sob demanda e protegido por dupla de idiomas para as seis línguas iniciais, preservando texto original somente enquanto o material localizado ainda não estiver disponível
- [x] Criar a primeira entrega protegida de diálogo localizado por cena — a rota exige sessão e lição autorizada, recebe somente identificador de cena e dupla de idiomas, prioriza IA local e retorna bloco futuro planejado sem conteúdo para idiomas ainda não lançados; TypeScript e suíte completa com 225 arquivos/544 testes aprovados
- [x] Conectar o início do diálogo à entrega localizada protegida — ao iniciar uma cena autenticada, a lição é autorizada antes de consultar o material; quando a localização fica pronta, os turnos no idioma estudado e o apoio nativo aparecem no painel sem expor currículo a visitantes; TypeScript e suíte completa com 225 arquivos/545 testes aprovados
- [x] Disponibilizar objetos localizados no painel protegido da Cena Imersiva — cada resposta de material autorizado contém objetos no idioma estudado e apoio nativo, exibidos junto aos turnos sem enviar vocabulário para visitantes; TypeScript e suíte completa com 226 arquivos/548 testes aprovados
- [x] Vincular a autorização assíncrona de material de cena ao identificador completo de cena e dupla de idiomas, impedindo reutilização após troca de contexto — concluído e detalhado no registro de validação subsequente
- [x] Vincular a autorização assíncrona de material de cena ao identificador completo de cena e dupla de idiomas, impedindo reutilização após troca de contexto — a consulta só é habilitada quando cena, idioma estudado e idioma nativo correspondem exatamente à autorização; TypeScript e suíte completa com 226 arquivos/549 testes aprovados
- [x] Exibir nas cenas um indicador positivo de bloco futuro quando o idioma estudado ainda não foi lançado, sem consultar ou expor conteúdo pedagógico não disponível — concluído e detalhado no registro de validação subsequente
...
- [x] Restringir diálogo, hotspots, Pareto, áudio e materiais pedagógicos das cenas a alunos autenticados, deixando aos visitantes apenas uma tela de acesso sem currículo — concluído e detalhado no registro de validação subsequente
...
- [x] Adicionar bloqueio HTTP no servidor para que `/immersive-scene` não entregue nem o shell da aplicação sem sessão válida — concluído e detalhado no registro de validação subsequente
- [x] Adicionar bloqueio HTTP no servidor para que `/immersive-scene` não entregue nem o shell da aplicação sem sessão válida — o middleware autentica antes de Vite/arquivos estáticos e responde 401 sem sessão; TypeScript e suíte completa com 230 arquivos/558 testes aprovados
- [x] Aplicar bloqueio HTTP uniforme a todas as rotas curriculares, preservando públicas apenas páginas institucionais, de preço e autenticação — concluído e detalhado no registro de validação subsequente
- [x] Aplicar bloqueio HTTP uniforme a todas as rotas curriculares, preservando públicas apenas páginas institucionais, de preço e autenticação — lições, Pareto, cenas, prática e módulos interativos respondem 401 sem sessão; preços e termos permanecem públicos; TypeScript e suíte completa com 232 arquivos/565 testes aprovados
- [x] Corrigir a divergência de implantação da barreira curricular: confirmar 401 em produção para lições e Pareto, não apenas para cenas imersivas — propagação concluída; lições, Pareto, prática e cenas retornam 401, enquanto preço permanece público com 200
...
- [x] Criar a primeira semente canônica protegida de conteúdo de cena — o diálogo e os quatro objetos da Praia Tropical agora existem em módulo somente do servidor e orientam a localização autenticada sem integrar currículo novo ao cliente; TypeScript e suíte completa com 232 arquivos/563 testes aprovados
- [x] Migrar o diálogo e os objetos da Praia Tropical para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — a cena consulta a semente autorizada, segura o início até a resposta e usa diálogo/hotspots ativos; o texto e os objetos canônicos não permanecem no catálogo cliente; TypeScript e suíte completa com 233 arquivos/569 testes aprovados
- [x] Migrar o diálogo e os objetos do Café Parisiense para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — concluído e detalhado no registro de validação subsequente
- [x] Migrar o diálogo e os objetos do Café Parisiense para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena usa material autorizado e não inclui esses textos no catálogo cliente; TypeScript e suíte completa com 233 arquivos/571 testes aprovados
- [x] Migrar o diálogo e os objetos da Floresta Encantada para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — concluído e detalhado no registro de validação subsequente
- [x] Migrar o diálogo e os objetos da Floresta Encantada para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena usa material autorizado e não inclui esses textos no catálogo cliente; TypeScript e suíte completa com 233 arquivos/573 testes aprovados
- [x] Migrar o diálogo e os objetos da cena Paris, França para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e oito objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/577 testes aprovados
- [x] Entregar o roteiro canônico da Praia Tropical apenas após autorização de lição, preparando sua troca pelo catálogo estático cliente — concluído e detalhado no registro de validação subsequente
- [x] Entregar o roteiro canônico da Praia Tropical apenas após autorização de lição, preparando sua troca pelo catálogo estático cliente — novo procedimento protegido exige chave de lição autorizada e retorna a semente somente para a cena migrada; TypeScript e suíte completa com 232 arquivos/566 testes aprovados
...
- [x] Migrar o diálogo e os objetos da cena Restaurante Brasileiro para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/583 testes aprovados

- [x] Migrar o diálogo e os objetos da cena Hotel de Luxo para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/585 testes aprovados

- [x] Migrar o diálogo e os objetos da cena Supermercado para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/587 testes aprovados

- [x] Migrar o diálogo e os objetos da cena Sala de Aula para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/589 testes aprovados
...
- [x] Migrar o diálogo e os objetos da cena Mercado Medieval para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/603 testes aprovados

- [x] Migrar o diálogo e os objetos da cena Cinema Moderno para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/605 testes aprovados

- [x] Migrar o diálogo e os objetos da cena Spa & Bem-Estar para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente — diálogo e seis objetos canônicos agora vivem na semente protegida; a cena aguarda material autorizado e o catálogo cliente não inclui esses textos; TypeScript sem erros e suíte completa com 234 arquivos/607 testes aprovados
