...
- [ ] Definir blocos independentes de idioma para inglês, espanhol, francês, italiano e alemão, com contrato técnico comum, conteúdo e voz próprios, estados públicos de disponibilidade e expansão gradual sem interromper alunos ativos
- [ ] Garantir que cada bloco de idioma aceite qualquer idioma nativo disponível como apoio; o idioma nativo do aluno e o idioma estudado devem permanecer independentes em explicações, ajuda, supervisão e interface
