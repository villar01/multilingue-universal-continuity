...
- [x] Produzir um vídeo de apresentação de James com áudio e movimento gerados no mesmo ativo para a frase inicial da Praia Tropical, substituindo o clipe de saudação genérico incompatível — MP4 H.264/AAC 1280×720 de 8 segundos publicado, usando a foto canônica existente como primeiro quadro; a confirmação auditiva e visual humana publicada permanece pendente
- [x] Substituir definitivamente o clipe genérico da abertura por um único vídeo de James com fala em inglês e lábios sincronizados para a frase de apresentação, sem combinar faixas externas ou movimento separado — o manifesto aponta para `james-tropical-introduction-exact-pair_7a9cb0a4.mp4`; TypeScript, 752 testes e renderização da cena aprovados; auditoria humana do clipe permanece pendente
- [x] Integrar a apresentação audiovisual única de James com uma única fonte de áudio: o MP4 aprovado toca seu próprio áudio e a faixa WAV masculina existente fica exclusiva para falha de carregamento ou reprodução, sem sobreposição — regressões verificam a ausência de WAV na abertura e o fallback somente em `onError`; TypeScript e suíte completa com 752 testes aprovados
