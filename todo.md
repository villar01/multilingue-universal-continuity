...
- [ ] Integrar ciclo Pareto em todo o app: vocabulário útil, recuperação ativa, escrita, memorização e criação de novas frases por nível — concluído na lição guiada, hotspots e painel de vocabulário das cenas; os demais fluxos de prática ainda precisam de integração
