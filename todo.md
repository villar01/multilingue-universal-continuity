...
- [x] Aplicar exceção visual de Ricardo para manter a boca estática durante fala neural, sem perder retrato, áudio ou indicador de atividade — política central desativa visemas, vídeo labial e loop de boca apenas para Ricardo; retrato, fala neural e estado ativo são preservados; TypeScript e 199 testes aprovados
...
- [x] Corrigir a comunicação da IA local para explicar com precisão que Qwen/Ollama atende geração local de texto e prática, enquanto voz neural e animação dependem dos mecanismos próprios do app — aviso Windows agora usa instalador oficial, esclarece privacidade/offline e não promete voz ou animação pelo Qwen; TypeScript e 186 testes aprovados
