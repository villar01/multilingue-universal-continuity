...
- [ ] Aplicar os três controles de sincronização: (1) clipe inicia somente no evento `playing` do áudio; (2) clipe exige fala correspondente e duração compatível; (3) ausência, rejeição, erro ou fim do áudio retorna imediatamente ao retrato estável
