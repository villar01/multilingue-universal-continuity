...
- [x] Impedir que a ativação de um service worker recarregue automaticamente a página e reinicie uma cena ou lição em andamento — a atualização assume o controle sem `window.location.reload()`, preservando rota e estado até a próxima abertura; TypeScript e 399 arquivos/998 testes aprovados
