...
- [ ] Modo imersão total — preferência persistente e controle presentes em Dashboard, ImmersiveScene e Lesson; a Cena Imersiva agora usa rótulos no idioma-alvo, oculta tradução/localização, roteiro e auxiliares nativos, preservando ajuda, saída e segurança; ocultação/tradução integral em SceneLesson, VoiceConversation e AIChatbot ainda pendente
