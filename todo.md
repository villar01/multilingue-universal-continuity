...
- [ ] Tornar a fala de James diretamente acessível após Iniciar Diálogo: abrir o painel já com comando Ouvir James claro e pronto, sem exigir localizar controle secundário, preservando a regra de reprodução por gesto explícito
...
- [ ] Fazer o professor apresentar cada cena com áudio audível e explicar o uso dos objetos: após a voz confirmar início, apresentar-se e orientar o aluno a clicar nos objetos; sem áudio, manter texto, retrato estável e comando de ouvir
