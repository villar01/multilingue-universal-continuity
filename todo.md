...
- [ ] Separar cada contexto semântico e capítulo A1 do Livro ABC em folha individual, para escalar a paginação real sem rolagem interna longa
...
- [x] Corrigir a resposta do Professor à pergunta “What is a pool?” na Praia Tropical, com explicação em inglês, sentido em português e voz masculina en-US de James — resposta local imediata não depende mais de geração remota; TypeScript, 17 regressões da cena e suíte completa com 654 testes aprovados
...
- [ ] Restaurar o acionamento dos clipes de movimento de James na Praia Tropical para Palm Tree, Wave, Ocean e Sand, preservando foto, voz en-US masculina e fallback visual
