...
- [ ] Aplicar gradualmente o contrato de feedback em todos os fluxos roteirizados do app, começando por Cena Imersiva, lição ativa, pronúncia, Pareto e revisão; Cena, lição, pronúncia e o Pareto aberto nas cenas já usam ou cobrem o contrato; falta auditar e integrar a revisão sem alterar interações livres, acessos protegidos ou conteúdo autorizado
