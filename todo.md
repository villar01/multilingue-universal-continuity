...
- [ ] Integrar ciclo Pareto em todo o app: vocabulário útil, recuperação ativa, escrita, memorização e criação de novas frases por nível — concluído na lição guiada, hotspots, painel de vocabulário das cenas e clipes familiares A1; os demais fluxos de prática ainda precisam de integração
