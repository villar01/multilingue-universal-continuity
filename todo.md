...
- [ ] Reforçar cabeçalhos HTTP de proteção sem alterar autenticação, conteúdo protegido, áudio, currículo, Pareto ou rotas existentes; validar CSP, frame-ancestors, MIME sniffing, referrer e permissões após mapeamento de compatibilidade
