...
- [ ] Preservar o áudio inicial de James confirmado por teste humano; durante os 6,32 segundos audíveis, mostrar acima do retrato a mesma frase inglesa em reprodução e exibir o clipe lateral previamente validado, sem trocar voz ou iniciar movimento silencioso
...
- [ ] Corrigir o defeito compartilhado de movimento: Praia Tropical e Floresta Encantada reproduzem o áudio de James, mas não promovem o deslocamento lateral a vídeo visível; preservar as faixas existentes e reparar o estado comum antes de ampliar novas cenas
