...
- [ ] Construir o programa Pareto de 1.000 palavras essenciais por idioma — distribuição por CEFR e situação, recuperação ativa, escrita obrigatória, frases novas, repetição espaçada e revisão de itens esquecidos
