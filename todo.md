...
- [ ] Corrigir a regressão da prévia oficial bloqueada por `frame-ancestors 'none'`/X-Frame-Options: manter proteção contra incorporação externa e liberar apenas a visualização dentro do painel oficial
