...
- [ ] Auditar o Livro SOS contra a estrutura curricular solicitada no PDF de referência antes de alterar mais a interface; preservar em conteúdo autoral todos os assuntos, exercícios e progressão pedagógica, sem reduções ou resumos
