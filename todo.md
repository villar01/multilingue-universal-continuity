...
- [x] Corrigir a reprodução real da voz neural e do áudio de reserva da Praia Tropical após o clique explícito do aluno — a primeira fala é pré-carregada sem tocar e reproduzida diretamente no clique de início do diálogo; MP3 neural decodificável confirmado, TypeScript sem erros e suíte completa com 221 arquivos/572 testes aprovados
