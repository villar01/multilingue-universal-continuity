...
- [ ] Impedir que a validação e a abertura legítima de cenas imersivas recebam respostas de sobrecarga ou acionem a recuperação local antes de renderizar o cenário
