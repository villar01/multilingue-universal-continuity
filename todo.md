...
- [x] Substituir o retângulo flutuante do Livro SOS nas cenas por um pequeno ícone de livro de capa dura, posicionado em canto livre sem cobrir fala, objetos, professor ou controles — cenas e lições usam ícone fechado de capa dura de 44 px no canto inferior esquerdo; a captura da Praia confirmou diálogo, objetos, professor e controles livres. TypeScript sem erros e 796 testes aprovados
