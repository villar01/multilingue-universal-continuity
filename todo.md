...
- [ ] Migrar o diálogo e os objetos da Praia Tropical para consumo autenticado da semente do servidor, removendo-os do catálogo estático cliente
- [ ] Entregar o roteiro canônico da Praia Tropical apenas após autorização de lição, preparando sua troca pelo catálogo estático cliente
