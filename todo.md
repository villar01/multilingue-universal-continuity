...
- [ ] Tornar a fala de James diretamente acessível após Iniciar Diálogo: o comando inicial agora se chama Ouvir apresentação de James e dispara a fala no gesto explícito; o painel mantém Ouvir James como repetição. Falta confirmação auditiva humana publicada
...
- [ ] Gerar e integrar faixas masculinas pré-gravadas de fallback para Palm Tree, Wave, Ocean e Sand, mantendo as rotas neurais prioritárias e os clipes de objeto condicionados ao áudio audível
- [ ] Impedir movimentos de fala de James sem áudio: iniciar clipes de saudação, objeto ou resposta apenas após evento `play` confirmado; em ausência, rejeição ou erro de áudio, manter retrato estável e comando de ouvir visível
...
- [ ] Produzir um vídeo de apresentação de James com áudio e movimento gerados no mesmo ativo para a frase inicial da Praia Tropical, substituindo o clipe de saudação genérico incompatível
- [ ] Substituir definitivamente o clipe genérico da abertura por um único vídeo de James com fala em inglês e lábios sincronizados para a frase de apresentação, sem combinar faixas externas ou movimento separado
- [ ] Aplicar política global aos professores: falas fixas só usam pares áudio–vídeo produzidos para a mesma frase; perguntas e respostas online usam retrato estável até haver motor facial em tempo real validado; proibir qualquer movimento genérico ou silencioso
- [ ] Avaliar uma prova de viabilidade gratuita de motor facial em tempo real para respostas online, com critérios de latência, qualidade, privacidade e fallback obrigatório ao retrato estável; não ativar em professores publicados sem validação humana
- [ ] Definir perfis adaptativos de sincronização: dispositivo capaz pode executar visemas locais em tempo real após validação; dispositivo básico usa retrato estável e áudio; serviço avançado futuro só poderá substituir o modo local depois de validação de qualidade e privacidade
- [ ] Proteger o modo gratuito: áudio, retrato estável e visemas locais validados nunca poderão ser removidos, limitados ou piorados para induzir adesão a serviço avançado opcional futuro
...
- [ ] Preservar cada acerto audiovisual por regressão e checkpoint: player único, faixa masculina de apresentação, gesto explícito, retrato estável fora da fala e movimento lateral somente durante áudio ativo
- [ ] Criar prova isolada de visemas locais guiados pelo mesmo elemento de áudio do professor: abertura, fechamento e arredondamento devem parar junto com pausa, erro ou fim; manter desligada até validação visual humana
