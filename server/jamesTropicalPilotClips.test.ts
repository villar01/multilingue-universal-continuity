...
describe("piloto de clipes de James na Praia Tropical", () => {
  it("preserva o retrato original e registra os sete clipes prontos", () => {
    ...
    expect(JAMES_TROPICAL_PILOT_CLIPS.filter((clip) => clip.trigger === "object_focus").map((clip) => clip.dialogue)).toEqual([
