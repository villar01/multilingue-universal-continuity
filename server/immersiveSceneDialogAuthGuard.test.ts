...
describe("diálogo roteirizado e sessão da cena imersiva", () => {
  it("abre o diálogo com texto visível, prepara a faixa e toca somente pelo comando explícito Ouvir inglês", () => {
    ...
    expect(startDialog).toContain("requestSpeechSafely(teacherSpeech.text, teacherSpeech.language, teacherSpeech.gender, teacherSpeech.purpose);");
