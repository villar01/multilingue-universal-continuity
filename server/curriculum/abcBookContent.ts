...
const PORTUGUESE_ENGLISH_BOOK: ABCBookDelivery = {
  ...
  semanticContrasts: [
    ...
    {
      id: "perception-listen-hear",
      level: "initial",
      kind: "near_meaning",
      focus: "listen / hear",
      contrast: "listen é prestar atenção de propósito a um som; hear é perceber um som, mesmo sem procurar por ele.",
      explanation: "Diferencie intenção e percepção. Você listen to music quando decide escutar; você hear a bird quando o som chega até você.",
      examples: [
        { target: "Listen to the birds in the park.", native: "Escute os pássaros no parque.", meaning: "atenção intencional" },
        { target: "I can hear children playing.", native: "Consigo ouvir crianças brincando.", meaning: "percepção de um som" },
      ],
      comprehensionPrompt: "A pessoa decide prestar atenção ou apenas percebe um som? Explique a intenção antes de escolher listen ou hear.",
      paretoPrompt: "Recupere listen, hear, birds, children e park; escreva uma ação intencional e uma percepção sonora.",
    },
    {
      id: "screen-see-watch",
      level: "initial",
      kind: "near_meaning",
      focus: "see / watch",
      contrast: "see pode indicar encontrar ou perceber algo visualmente; watch é observar uma atividade ou algo em movimento por algum tempo.",
      explanation: "Use watch para acompanhar um filme, jogo ou apresentação. Use see para dizer que viu alguém ou algo, sem enfatizar a observação contínua.",
      examples: [
        { target: "We are watching a film at the cinema.", native: "Estamos assistindo a um filme no cinema.", meaning: "acompanhar algo em movimento" },
        { target: "I can see the cinema from here.", native: "Consigo ver o cinema daqui.", meaning: "perceber visualmente" },
      ],
      comprehensionPrompt: "A pessoa acompanha uma atividade ou apenas percebe algo visualmente? Justifique a escolha.",
      paretoPrompt: "Recupere see, watch, film, cinema e here; descreva um filme em exibição e algo que você vê do lugar onde está.",
    },
    {
      id: "health-sick-ill",
      level: "intermediate",
      kind: "near_meaning",
      focus: "sick / ill",
      contrast: "sick e ill podem indicar doença; sick também aparece em expressões como feel sick para enjoo. O uso varia por região e contexto.",
      explanation: "O registro formal do professor prioriza ill ou unwell para descrever condição de saúde, enquanto sick é comum em conversa e pode indicar náusea.",
      examples: [
        { target: "She is ill and needs to rest.", native: "Ela está doente e precisa descansar.", meaning: "condição de saúde" },
        { target: "I feel sick after the ride.", native: "Estou enjoado ou enjoada depois do trajeto.", meaning: "náusea" },
      ],
      comprehensionPrompt: "A frase descreve doença geral ou enjoo? Explique o contexto e escolha uma forma formal quando necessário.",
      paretoPrompt: "Recupere ill, sick, rest, feel e ride; descreva uma condição de saúde e uma sensação de enjoo em frases separadas.",
    },
    {
      id: "quantity-some-any",
      level: "intermediate",
      kind: "near_meaning",
      focus: "some / any",
      contrast: "some costuma aparecer em afirmações e ofertas; any costuma aparecer em perguntas e negativas, embora o contexto possa mudar essa preferência.",
      explanation: "Não memorize apenas uma tradução. Observe se a frase afirma, pergunta ou nega uma quantidade disponível.",
      examples: [
        { target: "We need some apples for breakfast.", native: "Precisamos de algumas maçãs para o café da manhã.", meaning: "quantidade afirmada" },
        { target: "Do you have any fresh bread?", native: "Você tem pão fresco?", meaning: "pergunta sobre disponibilidade" },
      ],
      comprehensionPrompt: "A frase afirma uma quantidade ou pergunta se ela existe? Explique a escolha antes de completar a frase.",
      paretoPrompt: "Recupere some, any, apples, bread e breakfast; faça uma afirmação de compra e uma pergunta de disponibilidade.",
    },
    {
      id: "travel-trip-journey",
      level: "advanced",
      kind: "near_meaning",
      focus: "travel / trip / journey",
      contrast: "travel é a atividade geral de viajar; trip é uma viagem específica; journey enfatiza o percurso de um ponto a outro.",
      explanation: "Escolha pela perspectiva: atividade ampla, evento planejado ou caminho percorrido. Não use uma única tradução para os três contextos.",
      examples: [
        { target: "Travel teaches us about new places.", native: "Viajar nos ensina sobre novos lugares.", meaning: "atividade geral" },
        { target: "Our trip to Tokyo starts tomorrow.", native: "Nossa viagem a Tóquio começa amanhã.", meaning: "viagem específica" },
        { target: "The journey from the airport was long.", native: "O trajeto desde o aeroporto foi longo.", meaning: "percurso" },
      ],
      comprehensionPrompt: "A frase fala da atividade de viajar, de uma viagem específica ou do percurso? Explique qual pista do contexto decide a palavra.",
      paretoPrompt: "Recupere travel, trip, journey, Tokyo e airport; compare a atividade geral, um plano e o percurso em três frases curtas.",
    },
    {
      id: "place-go-visit",
      level: "initial",
      kind: "near_meaning",
      focus: "go / visit",
      contrast: "go indica deslocar-se para um lugar; visit destaca passar tempo em um lugar ou com uma pessoa.",
      explanation: "Use go para o movimento geral e visit quando a intenção é conhecer ou passar tempo no destino.",
      examples: [{ target: "We go to Paris in summer.", native: "Nós vamos a Paris no verão.", meaning: "deslocamento" }, { target: "We visit the museum in Paris.", native: "Nós visitamos o museu em Paris.", meaning: "conhecer ou passar tempo" }],
      comprehensionPrompt: "A frase destaca o deslocamento ou a experiência no destino? Explique antes de escolher o verbo.",
      paretoPrompt: "Recupere go, visit, Paris, museum e summer; descreva o trajeto e uma atividade no destino.",
    },
    {
      id: "nature-forest-woods",
      level: "intermediate",
      kind: "near_meaning",
      focus: "forest / woods",
      contrast: "forest costuma indicar uma área extensa de árvores; woods pode indicar uma área arborizada menor ou próxima.",
      explanation: "As duas palavras falam de árvores, mas o tamanho e o contexto ajudam a escolher a forma mais precisa.",
      examples: [{ target: "The forest is far from the city.", native: "A floresta fica longe da cidade.", meaning: "área extensa" }, { target: "We walked through the woods near the river.", native: "Caminhamos pelo bosque perto do rio.", meaning: "área arborizada próxima" }],
      comprehensionPrompt: "O contexto descreve uma área extensa ou um bosque próximo? Diga qual pista orienta a escolha.",
      paretoPrompt: "Recupere forest, woods, river, city e walk; compare duas áreas naturais em frases curtas.",
    },
    {
      id: "mountain-climb-hike",
      level: "intermediate",
      kind: "near_meaning",
      focus: "climb / hike",
      contrast: "climb enfatiza subir uma superfície ou montanha; hike é caminhar por uma trilha, normalmente por mais tempo.",
      explanation: "Observe a ação principal: subir exige climb; percorrer uma trilha usa hike.",
      examples: [{ target: "They climb the mountain at sunrise.", native: "Eles sobem a montanha ao nascer do sol.", meaning: "subir" }, { target: "We hike along the mountain trail.", native: "Fazemos uma caminhada pela trilha da montanha.", meaning: "caminhar em trilha" }],
      comprehensionPrompt: "A pessoa está subindo ou percorrendo uma trilha? Justifique a escolha pelo movimento descrito.",
      paretoPrompt: "Recupere climb, hike, mountain, trail e sunrise; contraste uma subida e uma caminhada.",
    },
    {
      id: "farm-field-farm",
      level: "intermediate",
      kind: "near_meaning",
      focus: "field / farm",
      contrast: "field é uma área aberta de terra; farm é a propriedade ou atividade agrícola que pode incluir vários campos.",
      explanation: "Não troque a área física pela propriedade inteira. O contexto mostra se a frase fala de um espaço ou de uma fazenda.",
      examples: [{ target: "The cows are in the field.", native: "As vacas estão no campo.", meaning: "área aberta" }, { target: "The family works on a farm.", native: "A família trabalha em uma fazenda.", meaning: "propriedade agrícola" }],
      comprehensionPrompt: "A frase indica uma área aberta ou a propriedade agrícola? Explique a diferença com uma palavra do contexto.",
      paretoPrompt: "Recupere field, farm, cows, family e work; descreva o lugar dos animais e o trabalho da família.",
    },
    {
      id: "port-ship-boat",
      level: "intermediate",
      kind: "near_meaning",
      focus: "ship / boat",
      contrast: "boat é um termo amplo para embarcação menor; ship normalmente descreve uma embarcação maior, usada em viagens ou carga.",
      explanation: "O tamanho e a função ajudam a escolher. Use ship para grandes viagens ou carga e boat para uma embarcação menor.",
      examples: [{ target: "The ship carries cargo across the sea.", native: "O navio transporta carga pelo mar.", meaning: "embarcação grande" }, { target: "A small boat is near the port.", native: "Um barco pequeno está perto do porto.", meaning: "embarcação menor" }],
      comprehensionPrompt: "A embarcação transporta carga em grande escala ou é pequena? Explique a escolha.",
      paretoPrompt: "Recupere ship, boat, port, cargo e sea; compare duas embarcações em contexto.",
    },
    {
      id: "spa-relax-rest",
      level: "intermediate",
      kind: "near_meaning",
      focus: "relax / rest",
      contrast: "relax significa aliviar tensão; rest significa parar uma atividade para recuperar energia.",
      explanation: "As ações podem ocorrer juntas, mas o foco muda: relax trata da tensão; rest trata da pausa e recuperação.",
      examples: [{ target: "A massage helps me relax.", native: "Uma massagem ajuda a relaxar.", meaning: "aliviar tensão" }, { target: "You should rest after a long day.", native: "Você deve descansar depois de um dia longo.", meaning: "recuperar energia" }],
      comprehensionPrompt: "A frase fala de aliviar tensão ou de recuperar energia? Explique o foco antes de responder.",
      paretoPrompt: "Recupere relax, rest, massage, day e energy; descreva duas formas de cuidado pessoal.",
    },
    {
      id: "family-airport-pick-up-drop-off",
      level: "intermediate",
      kind: "multiword_expression",
      focus: "pick up / drop off",
      contrast: "pick up é buscar alguém ou algo; drop off é deixar alguém ou algo em um destino.",
      explanation: "A partícula muda o papel no trajeto. Aprenda as locuções completas com pessoa, bagagem e destino.",
      examples: [{ target: "I will pick up my family at the airport.", native: "Vou buscar minha família no aeroporto.", meaning: "buscar" }, { target: "We can drop off the bags at the hotel.", native: "Podemos deixar as malas no hotel.", meaning: "deixar em um destino" }],
      comprehensionPrompt: "A pessoa vai buscar ou deixar alguém ou algo? Indique o destino antes de escolher a locução.",
      paretoPrompt: "Recupere pick up, drop off, family, bags, airport e hotel; descreva duas etapas de chegada.",
    },
    {
      id: "desert-alone-lonely",
      level: "advanced",
      kind: "near_meaning",
      focus: "alone / lonely",
      contrast: "alone descreve estar sem companhia; lonely descreve sentir solidão. Estar alone não implica estar lonely.",
      explanation: "Diferencie fato e sentimento. Use o contexto emocional para decidir se lonely é apropriado.",
      examples: [{ target: "The traveler is alone in the desert.", native: "A pessoa viajante está sozinha no deserto.", meaning: "sem companhia" }, { target: "She feels lonely after the trip.", native: "Ela se sente solitária depois da viagem.", meaning: "sentimento de solidão" }],
      comprehensionPrompt: "A frase informa ausência de companhia ou um sentimento? Explique por que as palavras não são intercambiáveis.",
      paretoPrompt: "Recupere alone, lonely, desert, traveler e feel; contraste uma situação e uma emoção.",
    },
    {
      id: "history-historic-historical",
      level: "advanced",
      kind: "near_meaning",
      focus: "historic / historical",
      contrast: "historic descreve algo importante na história; historical descreve algo relacionado ao passado ou ao estudo da história.",
      explanation: "Use historic para relevância excepcional; use historical para classificação, pesquisa ou referência ao passado.",
      examples: [{ target: "The castle was the site of a historic event.", native: "O castelo foi cenário de um evento histórico importante.", meaning: "importância na história" }, { target: "The guide explains historical details.", native: "O guia explica detalhes históricos.", meaning: "relacionado ao passado" }],
      comprehensionPrompt: "O contexto destaca importância excepcional ou apenas relação com o passado? Justifique a escolha.",
      paretoPrompt: "Recupere historic, historical, castle, guide e event; compare um fato marcante e uma explicação sobre o passado.",
    },
    {
      id: "garden-grow-raise",
      level: "advanced",
      kind: "near_meaning",
      focus: "grow / raise",
      contrast: "grow descreve desenvolvimento natural ou cultivo; raise enfatiza cuidar para desenvolver algo, especialmente animais, crianças ou níveis.",
      explanation: "Observe quem conduz a ação. Plantas grow; pessoas podem raise animals ou raise a question.",
      examples: [{ target: "The flowers grow in the garden.", native: "As flores crescem no jardim.", meaning: "desenvolvimento natural" }, { target: "They raise vegetables for the market.", native: "Eles cultivam vegetais para o mercado.", meaning: "cuidado para desenvolver" }],
...
const SCENE_SEMANTIC_CONTRAST_IDS: Record<string, string> = {
  ...
  park: "perception-listen-hear",
  cinema: "screen-see-watch",
  hospital: "health-sick-ill",
  supermarket: "quantity-some-any",
  tokyo: "travel-trip-journey",
  paris: "place-go-visit",
  forest: "nature-forest-woods",
  mountain: "mountain-climb-hike",
  farm: "farm-field-farm",
  port: "port-ship-boat",
  spa: "spa-relax-rest",
  airport_family: "family-airport-pick-up-drop-off",
  desert: "desert-alone-lonely",
  medieval: "history-historic-historical",
  garden: "garden-grow-raise",
};
